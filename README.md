...
---be sure that the raspberry pi and the computer you're using must be connected to the same network.
	1. On your laptop feel free to downlod the vnc viewer from this site: https://www.realvnc.com/en/connect/download/viewer/
	2. Run and open the application.
	3. Type the static ip adddress in the search bar and press enter.
In this project we have this configuration:
