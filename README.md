...
- for the keyboard goto applications menu > preferences > raspberry pi configuration > localization > set keyboard then set the layout to US
...
sudo reboot
```
###### to check for network connection, goto CLI type
```
ping 8.8.8.8
```
